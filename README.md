...
```
cd existing_repo
git remote add origin http://192.168.3.153/desarrollo-administrativo/centro-medico.git
git branch -M main
...
- [ ] [Set up project integrations](http://192.168.3.153/desarrollo-administrativo/centro-medico/-/settings/integrations)
