...
public class ConsultaMedicaCtrl implements Serializable {
    ...
    private String construirHtmlCertificado() {
        ...
        html.append("<!DOCTYPE html><html><head><meta charset='UTF-8'/>")
                ...
                .append(".membrete-bottom .mb-text{width:72%;text-align:right;font-family:Arial,sans-serif;font-size:11px;line-height:1.15;color:#b3b3b3;font-weight:600;padding-bottom:8px;}")
                .append("</style></head><body>")
                ...
                .append("<p class='firma'><br/><br/><br/><br/>Atentamente,</p>")
