...
public class Step1CommandAssembler {
    ...
    public Step1FichaService.Step1Command toCommand(Step1ViewData viewData) {
        return new Step1FichaService.Step1Command(
                ...
                viewData.autorizaTransfusion, viewData.tratamientoHormonal, viewData.tratamientoHormonalCual,
                viewData.examenReproMasculino, viewData.tiempoReproMasculino, viewData.ginecoExamen1,
                viewData.ginecoTiempo1, viewData.ginecoResultado1, viewData.ginecoExamen2, viewData.ginecoTiempo2,
                viewData.ginecoResultado2, viewData.ginecoObservacion, viewData.fum, viewData.gestas,
                viewData.partos, viewData.cesareas, viewData.abortos, viewData.planificacion, viewData.planificacionCual,
                viewData.discapTipo, viewData.discapDesc, viewData.discapPorc, viewData.catasDiagnostico,
                viewData.catasCalificada, viewData.nRealizaEvaluacion, viewData.nRelacionTrabajo, viewData.nObsRetiro,
                viewData.consTiempoConsumoMeses, viewData.consExConsumidor, viewData.consTiempoAbstinenciaMeses,
                viewData.consNoConsume, viewData.consOtrasCual, viewData.afCual, viewData.afTiempo,
