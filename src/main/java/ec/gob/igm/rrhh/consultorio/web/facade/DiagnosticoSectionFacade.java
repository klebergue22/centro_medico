...
public class DiagnosticoSectionFacade implements Serializable {
    ...
    public List<Cie10> completarCie10FilaPorCodigo(String query) { return diagnosticoViewDelegate.completarCie10FilaPorCodigo(query); }
    public List<Cie10> completarCie10FilaPorDescripcion(String query) { return diagnosticoViewDelegate.completarCie10FilaPorDescripcion(query); }
